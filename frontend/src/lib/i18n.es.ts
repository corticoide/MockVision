...
export const es: Record<string, string> = {
  ...
  "Cameras in error or degraded, changes waiting for a restart, and deliveries that gave up.":
    "Cámaras con error o degradadas, cambios que esperan un reinicio y entregas que se dieron por perdidas.",
